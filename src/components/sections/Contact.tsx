      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 border font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-base hover:scale-105 active:scale-95"
            style={{ backgroundColor: 'rgba(37,211,102,0.08)', borderColor: 'rgba(37,211,102,0.3)', color: '#1DA851' }}
          >
