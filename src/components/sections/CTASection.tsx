      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-[#25D366]/10 hover:bg-[#25D366]/20 border border-[#25D366]/30 font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-base text-white"
          >
            <svg viewBox="0 0 24 24" className="w-4 h-4 shrink-0" style={{ fill: '#25D366' }}>
