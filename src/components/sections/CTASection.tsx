      ...
      <div className="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2.5 bg-[#25D366] hover:bg-[#20c05c] font-semibold px-8 py-4 rounded-xl transition-all duration-200 text-base text-white shadow-lg shadow-[#25D366]/25 hover:scale-105 active:scale-95"
          >
